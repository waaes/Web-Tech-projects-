...
<html>
<head>
<title>Admin Accommodation Bookings</title>
<meta charset="utf-8">
...
<div class="dropdown">		
  ...
  <article>
   <!-- Admin Personal Accommodation Bookings. -->
  <table>
			<tr>
...
?>
		<tr>
			...
			<td>
			    <a href="ad_accom_mod.php?edited=1&id=<?php echo $row->accid; ?>" target="_blank" style="text-decoration:none">Edit</a>
			</td>
			<td>
				<a href="delete_accommodation.php?deleted1=1&id=<?php echo $row->accid; ?>" style="text-decoration:none">Delete</a>
			</td>
		</tr>
<?php
	}
