...
if(isset($_POST['btn']))
{
	...
	$cpassw=$_POST['cpsw'];
	  ...
	  $t= move_uploaded_file($tmp,$target);
		...
		{
			echo "Updated";
			header('Refresh:0; admin_pro.php');
		}else{
			echo " :( ";
		}
	}
...
<ul id="head">
  <li id="a1"><a  href="#home">Home</a></li>
  <li id="a2"><a  href="#news">News</a></li>
  <li id="a3"><a  href="#contact">Contact</a></li>
  <li id="a4" ><a href="#about">About</a></li>
  <li id="a5" style="float:right;"><a  href="logout.php">Logout</a></li> 
</ul>
...
<section>
  ...
  <h3>Account</h3><hr>
    <ul id="ul1">
      ...
      <li><a  href="homepage.php" target="_blank" style="text-decoration:none">Home</a></li>
    ...
    <ul id="ul2">
      ...
      <li><a href="#" style="text-decoration:none">Search Members</a></li>
	...
	<ul id="ul3">
		 ...
		 <li><a href="#" style="text-decoration:none">Create New Event</a></li>		 
	</ul>	 
