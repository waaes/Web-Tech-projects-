...
<html>
<head>
<title>Traveler Transport Modify</title>
<meta charset="utf-8">
    ...
    <table style="visibility:visible">
			...
			<tr>
			   <td>
			     ...
			     <input type="reset" value="Reset" name="ret" style="align:right"><pre style="display:inline">   </pre><input type="submit" value="Save Change" onclick="return validate()" name="btn" style="align:right">
			   </td>
			</tr>
	</table>
   </form>	
