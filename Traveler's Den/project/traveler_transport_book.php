...
<html>
<head>
<title>Traveler Transport Bookings</title>
<meta charset="utf-8">
...
<div class="dropdown">		
  ...
  <article>
<!-- Traveler Personal Transport Bookings. -->
  <table>
			<tr>
				<th>Transport Type</th><th>Company</th><th>Seats</th><th>Departure On</th><th>Return On</th><th>Email</th><th>Contact</th><th>User</th><th>Status</th><th colspan="2">Operation</th>
			</tr>
<?php
$sql="select * from transportation WHERE book_name='{$username}' ";
...
?>
		<tr>
			...
			<td>
			    <a href="tr_trans_mod.php?edited=1&id=<?php echo $row->trans_id; ?>" target="_blank" style="text-decoration:none">Edit</a>
			</td>
			<td>
				<a href="tr_delete_transport.php?deleted=1&id=<?php echo $row->trans_id; ?>" style="text-decoration:none">Delete</a>
			</td>
		</tr>
<?php
	}
