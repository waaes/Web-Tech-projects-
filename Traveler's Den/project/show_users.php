...
<div class="dropdown">		
  ...
  <table>
			<tr>
				<th>Name</th><th>Email Address</th><th>Phone No</th><th>Status</th><th colspan="2">Operation</th>
			</tr>
<?php
		...
		<tr>
			...
			<div class="dropdown">	
			   <button class="dropbtn">
                    ...
                    <div class="dropdown-content">
                                   <a href="delete_user.php?confirmed=1&id=<?php echo $row->mindex; ?>" style="text-decoration:none">confirm</a>
				                   <a href="delete_user.php?stall=1&id=<?php echo $row->mindex; ?>" style="text-decoration:none">pending</a>
						           <a href="delete_user.php?cancel=1&id=<?php echo $row->mindex; ?>" style="text-decoration:none">canceled</a>
                    </div>
	       </div>
			
			</td>
				<td><a href="delete_user.php?deleted=1&id=<?php echo $row->mindex; ?>" style="text-decoration:none">Delete</a>
			</td>
		</tr>
<?php
	}
