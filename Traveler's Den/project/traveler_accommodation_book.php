...
<html>
<head>
<title>Traveler Accommodation</title>
<meta charset="utf-8">
...
<div class="dropdown">		
  ...
  <article>
  <!-- Traveler's Personal Accommodation Bookings. -->
  <table>
			<tr>
...
<?php
$sql="select * from accommodation WHERE book_name='{$username}' ";
...
?>
		<tr>
			...
			<td>
			    <a href="tr_accom_mod.php?edited=1&id=<?php echo $row->accid; ?>" target="_blank" style="text-decoration:none">Edit</a>
			</td>
			<td>
				<a href="tr_delete_accommodation.php?deleted=1&id=<?php echo $row->accid; ?>" style="text-decoration:none">Delete</a>
			</td>
		</tr>
<?php
	}
