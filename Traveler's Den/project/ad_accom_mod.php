...
<html>
<head>
<title>Admin Accommodation Modification</title>
<meta charset="utf-8">
...
function validate(){
	...
	ap=document.acc_fm.ac_type.value;
	rs=document.acc_fm.ac_spec.value;
	ac=document.acc_fm.ac_comp.value;
	ci=document.acc_fm.chkin_date.value;
	co=document.acc_fm.chkout_date.value;
	mail=document.acc_fm.mail_ad.value;
	pn=document.acc_fm.phone_numb.value;
	...
	else if(pn == "")
	{
		...
		document.getElementById("msg6").innerHTML="Missing7";
		return false;
...
<div class="dropdown">		
  ...
  <article>
  <!-- edit accommodation. -->
  <form action="" method="post" name="acc_fm">
    <table style="visibility:visible">
			...
			<tr>
				<td>Accommodation type:<pre style="display:inline">		 </pre><input size="50" type="text" name="ac_type" value="<?php echo $accom_type; ?>" required><span id="msg"></span></td>
				
			</tr>
			<tr>
				<td>Room Specification:<pre style="display:inline">		 </pre><input size="50" type="text" name="ac_spec" value="<?php echo $r_spec; ?>" required><span id="msg1"></span></td>
				
			</tr>
			<tr>
				<td>Accommodation Company:<pre style="display:inline">	        </pre> <input size="50" type="text" name="ac_company" value="<?php echo $accom_company; ?>" required><span id="msg2"></span></td>
			</tr>
			<tr>
				<td>Check In Date:<pre style="display:inline">		        </pre> <input style="width:385px" type="Date" name="chkin_date" value="<?php echo $c_in; ?>"required><span id="msg3"></span></td>
			</tr>
			<tr>
				<td>Check Out Date:<pre style="display:inline">		        </pre> <input style="width:385px" type="Date" name="chkout_date" value="<?php echo $c_out; ?>"required><span id="msg4"></span></td>
			</tr>
			<tr>
