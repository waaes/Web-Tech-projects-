...
<html>
<head>
<title>Admin Transport Bookings</title>
<meta charset="utf-8">
...
<div class="dropdown">		
  ...
  <article>
   <!-- Admin Personal Transport Bookings. -->
  <table>
			<tr>
...
?>
		<tr>
			...
			<td>
			    <a href="ad_trans_mod.php?edited=1&id=<?php echo $row->trans_id; ?>" target="_blank" style="text-decoration:none">Edit</a>
			</td>
			<td>
				<a href="delete_transport.php?deleted1=1&id=<?php echo $row->trans_id; ?>" style="text-decoration:none">Delete</a>
			</td>
		</tr>
<?php
	}
