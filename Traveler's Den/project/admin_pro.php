...
?>
		<tr>
			<td style="text-align:top"> First Name: <?php echo $row->fsname; ?><hr></td> <td> <img style="border-radius: 60%; vertical-align: middle;" alt='not found' src="<?php echo $row->pro_photo; ?>" width='130px' height='130px'/> </td>
		</tr>
        <tr>
			<td> Last Name: <?php echo $row->ltname; ?><hr></td>
		</tr>
        <tr>
			<td> User Name: <?php echo $row->uname; ?><hr></td>
		</tr>
        <tr>
			<td> Date of Birth: <?php echo $row->dob; ?><hr></td>
		</tr>
        <tr>
			<td> Email Address: <?php echo $row->mail; ?><hr></td>
		</tr>
        <tr>
			<td> Contact Number: <?php echo $row->phnumb; ?><hr></td>
		</tr>		
         <tr>
			<td>
			    <a href="ad_pro_mod.php?edited=1&id=<?php echo $row->mindex; ?>" target="_blank" style="text-decoration:none">Edit Profile Infos</a>
			</td>
		 </tr>
