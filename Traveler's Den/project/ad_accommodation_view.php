...
<div class="dropdown">		
  ...
  <span>
		<b>Search User:</b> <input type="text" name="search" placeholder="Search here"> <input type="button" value="Search" name="sbtn">
  </span><br><br>
  <table>
			<tr>
				<th>Accommodation Type</th><th>Company</th><th>Room Specification</th><th>check In</th><th>Check Out</th><th>Email</th><th>Contact</th><th>User</th><th>Status</th><th colspan="2">Operation</th>
			</tr>
<?php
...
?>
		<tr>
			...
			<td><?php echo $row->acc_company; ?></td>
			<td><?php echo $row->room_spec; ?></td>
			...
			<div class="dropdown">	
			   <button class="dropbtn">
                    ...
                    <div class="dropdown-content">
                                   <a href="delete_accommodation.php?confirmed=1&id=<?php echo $row->accid; ?>" style="text-decoration:none">confirm</a>
				                   <a href="delete_accommodation.php?stall=1&id=<?php echo $row->accid; ?>" style="text-decoration:none">pending</a>
						           <a href="delete_accommodation.php?cancel=1&id=<?php echo $row->accid; ?>" style="text-decoration:none">canceled</a>
                    </div>
	       </div>
			
			</td>
				<td><a href="delete_accommodation.php?deleted=1&id=<?php echo $row->accid; ?>" style="text-decoration:none">Delete</a>
			</td>
		</tr>
<?php
	}
